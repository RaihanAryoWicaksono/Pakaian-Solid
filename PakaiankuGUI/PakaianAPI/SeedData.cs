                ...
                serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                if (!await context.Users.AnyAsync())
                {
                    await context.Users.AddRangeAsync(
                        new Models.User { Username = "admin", Password = "admin123", Role = Models.UserRole.Admin },
                        new Models.User { Username = "customer1", Password = "customerpassword", Role = Models.UserRole.Customer },
                        new Models.User { Username = "dimas", Password = "123", Role = Models.UserRole.Admin },
                        new Models.User { Username = "rudi", Password = "321", Role = Models.UserRole.Customer }
                    );
