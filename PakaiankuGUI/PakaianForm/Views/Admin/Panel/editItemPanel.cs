...
using PakaianLib; // Untuk StatusPakaian

namespace PakaianForm.Views.Admin.Panel
{
    public partial class editItemPanel : UserControl
    {
        private PakaianDtos _currentPakaian; // Variabel untuk menyimpan data pakaian di panel ini

        // Event yang akan dipicu ketika tombol Edit diklik
        public event EventHandler<PakaianDtos> OnEditClicked;
        // Event yang akan dipicu ketika tombol Hapus diklik
        public event EventHandler<PakaianDtos> OnDeleteClicked;
        ...
        public PakaianDtos Pakaian // <--- INI ADALAH DEFINISI PROPERTI 'Pakaian'
        {
