...
namespace PakaianForm.Views.Admin.Panel
{
    public partial class KelolaPakaian : UserControl
    {
        ...
        private List<PakaianDto> _allPakaian = new List<PakaianDto>();
        ...
        private void ItemPanel_OnEditClicked(object sender, PakaianDto pakaianToEdit)
        {
        ...
        private async void ItemPanel_OnDeleteClicked(object sender, PakaianDto pakaianToDelete)
        {
        ...
        private async Task PerformSearch()
        {
            ...
            try
            {
                ...
                List<PakaianDto> searchResults;

                if (string.IsNullOrEmpty(searchTerm))
                {
                    searchResults = new List<PakaianDto>(_allPakaian);
                }
                else
                {
